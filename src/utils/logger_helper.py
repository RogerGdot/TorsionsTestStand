"""
Logger Helper für Torsions Test Stand
======================================
Enthält Logger-Klassen für GUI-Integration und formatierte Ausgabe.

Klassen:
- GuiLogger: Qt-Signal basierter Logger für GUI-Integration
- WrappingFormatter: Logger-Formatter mit automatischem Zeilenumbruch
"""
